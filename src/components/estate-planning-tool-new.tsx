      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            <FileText className="inline-block w-10 h-10 mr-3 text-blue-400" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 sticky top-8">
              <h4 className="text-lg font-semibold text-white mb-6">Your Planning Profile</h4>
              
              <div className="space-y-4">
                <div className={`p-4 rounded-lg border ${selectedFamily ? 'bg-white/10 border-white/30' : 'bg-white/5 border-white/10'}`}>
                  <div className="text-sm text-blue-200 mb-1">Family Situation</div>
                  <div className="text-white font-medium">
                    {selectedFamily ? getSelectedItem(familySituations, selectedFamily)?.name : 'Not selected'}
                  </div>
                </div>

                <div className={`p-4 rounded-lg border ${selectedAssets ? 'bg-white/10 border-white/30' : 'bg-white/5 border-white/10'}`}>
                  <div className="text-sm text-blue-200 mb-1">Asset Level</div>
                  <div className="text-white font-medium">
                    {selectedAssets ? getSelectedItem(assetLevels, selectedAssets)?.name : 'Not selected'}
                  </div>
                </div>

                <div className={`p-4 rounded-lg border ${selectedPriority ? 'bg-white/10 border-white/30' : 'bg-white/5 border-white/10'}`}>
                  <div className="text-sm text-blue-200 mb-1">Planning Priority</div>
                  <div className="text-white font-medium">
