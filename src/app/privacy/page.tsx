            ...
            <div className="space-y-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li>• <a href="#hipaa-glba" className="text-primary hover:underline">Applicability of HIPAA and GLBA</a></li>
                  <li>• <a href="#personal-info" className="text-primary hover:underline">Personal Information We Collect / Sources of Personal Information</a></li>
                  <li>• <a href="#use-info" className="text-primary hover:underline">Use of Personal Information</a></li>
                  <li>• <a href="#disclosing-info" className="text-primary hover:underline">Disclosing Personal Information</a></li>
                  <li>• <a href="#cookie-policy" className="text-primary hover:underline">Cookie Policy</a></li>
                  <li>• <a href="#children" className="text-primary hover:underline">Children Under the Age of 16</a></li>
                  <li>• <a href="#state-rights" className="text-primary hover:underline">Your State Privacy Rights</a></li>
                  <li>• <a href="#retention" className="text-primary hover:underline">Retention of Data</a></li>
                  <li>• <a href="#security" className="text-primary hover:underline">Data Security</a></li>
                  <li>• <a href="#third-party" className="text-primary hover:underline">Third-Party Applications and Integrations</a></li>
              ...
              <section id="hipaa-glba">
                <h2 className="text-2xl font-semibold mb-4">Applicability of HIPAA and GLBA</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              <section id="personal-info">
                <h2 className="text-2xl font-semibold mb-4">Personal Information We Collect / Sources of Personal Information</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border border-border rounded-lg">
                      ...
                      <tbody>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Contact Information</td>
                          <td className="border-b border-border px-4 py-3">Consumers' and Agents' name, phone number, and email address, as well as Consumers' postal address. We may collect this information about Consumers from Lead Vendors, Agents, insurance carriers, data brokers, and agencies.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Login Credentials</td>
                          <td className="border-b border-border px-4 py-3">This includes username and password when Agents or Consumers choose to create an account with us.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Identification Information*</td>
                          <td className="border-b border-border px-4 py-3">Agents' National Producer Number and Social Security number. Consumers' driver's license, Social Security, and/or similar government-issued identification numbers.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Demographic Information*</td>
                          <td className="border-b border-border px-4 py-3">Consumers' age, date of birth, marital status, language preference, ethnicity, race, and sex or gender.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Health Information*</td>
                          <td className="border-b border-border px-4 py-3">Consumers' health information provided in the course of discussions with an Agent or representative, which is relevant to the processing of an application for an insurance or financial product.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Commercial Information</td>
                          <td className="border-b border-border px-4 py-3">Information about the products requested by Consumers, including information entered into insurance and/or financial product applications.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Internet Activity</td>
                          <td className="border-b border-border px-4 py-3">Automatically collected information on users' interaction with the Platform, including browsing history, duration of browsing session, device ID, and IP address.</td>
                        </tr>
                        <tr>
                          <td className="border-b border-border px-4 py-3 font-medium">Geolocation Data</td>
                          <td className="border-b border-border px-4 py-3">We collect geolocation, which may include precise geolocation, from users automatically and may also collect this from advertising networks.</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
              ...
              <section id="use-info">
                <h2 className="text-2xl font-semibold mb-4">How We Use the Personal Information We Collect</h2>
                <div className="space-y-4 text-muted-foreground">
              ...
              <section id="disclosing-info">
                <h2 className="text-2xl font-semibold mb-4">How We Share the Personal Information We Collect</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              {/* Children Under 16 */}
              <section id="children">
                <h2 className="text-2xl font-semibold mb-4">Children Under the Age of 16</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              <section id="state-rights">
                <h2 className="text-2xl font-semibold mb-4">Your State Privacy Rights</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              <section id="third-party">
                <h2 className="text-2xl font-semibold mb-4">Third Party Applications and Integrations</h2>
                <div className="space-y-4 text-muted-foreground">
                  <p>
              ...
              <section id="contact">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4">
                    <p><strong>Phone:</strong> (817) 800-4253</p>
                    <p><strong>Email:</strong> info@hawkinsig.com</p>
                    <p><strong>Address:</strong><br />
                      101 Summit Ave. Suite #215A<br />
                      Fort Worth, TX 76102
                    </p>
                  </div>
                </div>
