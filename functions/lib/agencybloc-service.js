...
exports.createLeadWithNote = exports.mapToAgencyBlocLead = exports.attachLeadNote = exports.createAgencyBlocLead = exports.searchLeadByPhone = void 0;
...
exports.searchLeadByPhone = searchLeadByPhone;
/**
 * Create a new lead in AgencyBloc
 */
async function createAgencyBlocLead(leadData) {
    const formData = new URLSearchParams({
        sid: AGENCYBLOC_CONFIG.sid,
        key: AGENCYBLOC_CONFIG.key,
        ...leadData,
...
exports.createAgencyBlocLead = createAgencyBlocLead;
/**
 * Create a note with custom field data attached to a lead
 */
async function attachLeadNote(recordId, customData, formType = 'Website Form') {
...
function formatCustomFieldsNote(data, formType) {
    ...
    if (data.preferredContactMethod || data.preferredContactTime) {
        ...
        if (data.preferredContactMethod)
            note += `Preferred Contact: ${data.preferredContactMethod}\n`;
    ...
    if (data.leadScore) {
        ...
        if (data.leadPriority)
            note += `Priority: ${data.leadPriority}\n`;
        note += `\n`;
    }
    // Additional Notes
 ...
 */
function mapToAgencyBlocLead(formData) {
    ...
    if (formData.insuranceType)
        leadData.coverage_type = mapCoverageType(formData.insuranceType);
    // Lead source
...
exports.createLeadWithNote = createLeadWithNote;
//# sourceMappingURL=agencybloc-service.js.map