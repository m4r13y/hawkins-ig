 ...
 */
function mapToAgencyBlocLead(formData, formType = 'Website Form') {
    var _a, _b;
    ...
    const leadData = {
        ...
        last_name: formData.lastName || formData.last_name || ((_b = formData.name) === null || _b === void 0 ? void 0 : _b.split(' ').slice(1).join(' ')) || '',
    };
    // Optional fields
    if (formData.email)
